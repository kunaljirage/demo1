    ...
    <header>
          ...
          {user && (
            <div className="navbar-nav  justify-content-end">
              <div className="nav-item">
                <li className="nav-link" onClick={()=> openProfile()}>
                  <svg
      ...
      <div className="container-fluid  justify-content-end" id="profile"   style={{position:'fixed',display:"none",marginTop:"-11px"}}>
         <div className="card p-2">
          <div className="d-flex justify-content-end"><span onClick={() => closeProfile()} style={{padding:'5px',fontSize:'20px',fontWeight:'lighter',color:'#d1cdcd'}}>X</span></div>
